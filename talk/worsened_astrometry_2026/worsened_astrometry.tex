  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node[anchor=north, yshift=-8.2mm, minimum width=\paperwidth, minimum height=4mm,
      ...
      {\scriptsize\bfseries\color{red!70!black}
       JULY 2026: INTERIM MITIGATION --- superseded by the v11 foundation fix (slides 12--16)};
...
\begin{frame}{August: the trail --- displacements follow one instrument-locked axis}
  \begin{columns}
    \column{0.46\textwidth}
      \includegraphics[width=\textwidth]{nb23_offender_directions.png}
    \column{0.52\textwidth}
      \begin{itemize}
...
\begin{frame}{The mechanism: a hard S/N clamp erases bright-star cores}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{nb23_clamp_onset.png}
  \end{center}
  \vspace{-0.4em}
  {\small
  \begin{itemize}
    ...
    \item Rotating the star's local image $180^\circ$ flips the displacement (median $\cos=+0.91$): the direction is written in the clamped plateau's elongated boundary.
  \end{itemize}}
\end{frame}
