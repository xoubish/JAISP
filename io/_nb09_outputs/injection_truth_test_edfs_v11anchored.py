"""Synthetic-injection truth test on EDF-S (OOD), v11+ANCHORED head (2026-09-03).
...
adopted anchored head (production + patchval25 twins) on the v11 foundation.
...
HEADS = {
    "anchored": ROOT / "models/checkpoints/latent_position_v11_anchored/best.pt",
    "anchored_pv25": ROOT / "models/checkpoints/latent_position_v11_anchored_patchval25/best.pt",
}
LABELS = torch.load(ROOT / "data/detection_labels/centernet_q1_edfs_vissep_thresh03.pt",
...
json.dump(out, open(ROOT / "io/_nb09_outputs/injection_truth_results_edfs_v11anchored.json", "w"))
print("\nsaved io/_nb09_outputs/injection_truth_results_edfs_v11anchored.json")
