"""Synthetic-injection truth test, v11-label anchored head mega edition (2026-09-06).

Same protocol as injection_truth_test_q1.py (same seed, tiles, SNR levels) with the
adopted v11-label anchored head (production + patchval25 twins) on the v11 foundation.
...
N_TILES = 0  # 0 = all patch-25 tiles
N_INJECT = 20
SNR_LEVELS = [5, 7, 10, 15, 30]
RNG = np.random.default_rng(20260611)
OUT_PATH = ROOT / "io/_nb09_outputs/injection_truth_results_q1_v11labels_mega.json"
PARTIAL_PATH = ROOT / "io/_nb09_outputs/injection_truth_results_q1_v11labels_mega.partial.json"
...
# ---- tiles: sorted patch-25 stems; N_TILES=0 means all ----
rdir, edir = ROOT / "data/rubin_tiles_patch25", ROOT / "data/euclid_tiles_all_q1"
