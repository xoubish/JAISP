...
FOUNDATION = ROOT / "models/checkpoints/jaisp_v10_q1_long/checkpoint_best.pt"
HEADS = {
    "prod": ROOT / "models/checkpoints/latent_position_q1_vissep/best.pt",
    "patchval": ROOT / "models/checkpoints/latent_position_q1_vissep_patchval25/best.pt",
}
...
json.dump(out, open(ROOT / "io/_nb09_outputs/injection_truth_results_q1.json", "w"))
print("\nsaved io/_nb09_outputs/injection_truth_results_q1.json")
