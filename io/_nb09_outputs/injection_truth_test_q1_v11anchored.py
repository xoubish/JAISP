"""Synthetic-injection truth test, v11+ANCHORED head edition (2026-09-02).
...
LABELS = torch.load(ROOT / "data/detection_labels/centernet_q1_790_vissep_thresh03.pt",
...
json.dump(out, open(ROOT / "io/_nb09_outputs/injection_truth_results_q1_v11anchored.json", "w"))
print("\nsaved io/_nb09_outputs/injection_truth_results_q1_v11anchored.json")
