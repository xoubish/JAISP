...
\begin{enumerate}
  ...
  \item A measurement of a coherent degree-scale concordance field between the
    Rubin and \textit{Euclid} astrometric solutions, shown to be stable across
    foundation-model versions and fitting choices.
